...
export class AppHistory {
  ...
  /**
   * Valida si @param data tiene arrays vacios 
   * sino tiene cambia el estado de infoPrescriptions, inforRooms, inforMeetings
   */
  getDataSearch(data){
    if(data){
  ...
  /**
   * Remueve del DOM la informacion de la busqueda del componente <app-search>
   */
