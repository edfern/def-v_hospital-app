...
export class AppMeetingNew {
   ...
   * 
   * Valido los datos que se han mandado por el prop editMeeting si es true y el type es patient
   * cambia el estado de los State date,time y muestra el formulario correspondiente
   * 
   * Si el prop editMeeting es true pero el type es guest cambia el State de 
   * idGuestAppointment, name, surName, address, date, time y muestra el formulario correspondiente.
   * 
   * Si el prop editMeeting es false mostrara el formulario vacio.
   */
  componentWillLoad(){
    if(this.editMeeting){
  ...
  /**
   * Metodo que covierte un Date Sql a un Date que pueda leer un input type Date 
   * @param time12h dato que se envia desde la base de datos
   */
  ...
  /**
   * Los metodos handle cambia el estado de los parametos
   * name, date, time, phone, surNmae, address
   * @param e evento por defecto (onInput)
   */
  ...
  /**
   * Despliega el form si el type es patient muestra el de patient
   * si el type es guest muestra el de guest
   */
  ...
  /**
   * Realiza las operaciones si el State editMeeting es true y el type es patient realiza un Update patient
   * Si el State editMeeting es true y el type es guest realiza un update guest
   * si el state editMeeting es false quiere decir que es una nueva cita.
   */
  ...
  /**
   * Metodo que realiza un delete si el type es patient o guest
   * @param e 
   */
  ...
  /**
   * Metodo que guarda una nueva cita de un paciente que ya esta registrado.
   */
  @Method()
  ...
  /**
   * Metodo que realiza un update en una cita de un paciente
   */
  @Method()
  ...
  /**
   * Metodo que realiza un delete de una cita type patient
   */
  @Method()
  ...
  /**
   * Metodo que realiza un delete de la cita de un guest
   */
  @Method()
  ...
  /**
   * Metodo que realiza un update de la cita de un guest
   */
  @Method()
  ...
  /**
   * Metodo que guarda una cita de un guest
   */
  @Method()
