...
export class AppLogin {
  ...
  alertDemo = () => (
    <app-alert messages='Credentials Demo USER 1 gmal: user1@gmail.com pass: user1 USER 2 gmail: user2@gmail.com pass: user2' typeMessage={2}></app-alert>
  )
          ...
          <div class="container-login100 enableBlur">
            ...
            <div class="demo">
              <div>
                ...
                <h3>user 1</h3>
                <span>gmail: user1@gmail.com</span>
                <span>pass: user1</span>
                <h3>user 2</h3>
                <span>gmail: user2@gmail.com</span>
                <span>pass: user2</span>
              </div>
            </div>
          </div>
        </div>
