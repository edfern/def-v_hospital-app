...
export namespace Components {
    ...
    interface AppHome {
        /**
          * Obtiene la informacion del usuario y validad la hora de inicio de sesion  si el tiempo transcurrido es de 20 minutos cerrara la sesion y el usuario  tendra que iniciar sesion de nuevo
         */
    ...
    interface AppMeeting {
        /**
          * Metodo ASYNC obtiene las citas mas recientes Type: Patients de la base de datos
         */
